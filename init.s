...
.LBB14:
.LBB15:
	.stabn	68,0,13,.LM16-.LFBB1
.LM16:
	xorl	%eax, %eax
	movq	%r12, %rdi
	movl	%r15d, %esi
	call	cprintf@PLT
	.stabn	68,0,14,.LM17-.LFBB1
.LM17:
	testl	%r15d, %r15d
	je	.L5
	.stabn	68,0,15,.LM18-.LFBB1
.LM18:
	leal	-4(%rbp), %ebx
.LBB16:
.LBB17:
	.stabn	68,0,13,.LM19-.LFBB1
.LM19:
	xorl	%eax, %eax
	movq	%r12, %rdi
	movl	%ebx, %esi
	call	cprintf@PLT
	.stabn	68,0,14,.LM20-.LFBB1
.LM20:
	testl	%ebx, %ebx
	je	.L6
	.stabn	68,0,15,.LM21-.LFBB1
.LM21:
	leal	-5(%rbp), %edi
	call	test_backtrace
.L7:
...
.LFB1:
	...
	popq	%rax
	.cfi_def_cfa_offset 8
	.stabn	68,0,28,.LM32-.LFBB2
.LM32:
	leaq	edata(%rip), %rdi
	.stabn	68,0,28,.LM33-.LFBB2
.LM33:
	leaq	end(%rip), %rdx
	xorl	%esi, %esi
	subl	%edi, %edx
	.stabn	68,0,22,.LM34-.LFBB2
.LM34:
	subq	$8, %rsp
	.cfi_def_cfa_offset 16
	.stabn	68,0,28,.LM35-.LFBB2
.LM35:
	call	memset@PLT
	.stabn	68,0,32,.LM36-.LFBB2
.LM36:
	call	cons_init@PLT
...
.LM42:
	...
	.p2align 3
.L20:
	.stabn	68,0,74,.LM43-.LFBB3
.LM43:
	xorl	%edi, %edi
	call	monitor@PLT
	jmp	.L20
.L23:
	.stabn	68,0,60,.LM44-.LFBB3
.LM44:
	movq	%rbp, panicstr(%rip)
	.stabn	68,0,63,.LM45-.LFBB3
.LM45:
#APP
# 63 "kern/init.c" 1
	cli; cld
# 0 "" 2
	.stabn	68,0,65,.LM46-.LFBB3
.LM46:
#NO_APP
	leaq	224(%rsp), %rax
	.stabn	68,0,66,.LM47-.LFBB3
.LM47:
	movl	%esi, %edx
	movq	%rdi, %rsi
	.stabn	68,0,65,.LM48-.LFBB3
.LM48:
	movl	$24, (%rsp)
	movq	%rax, 8(%rsp)
	leaq	32(%rsp), %rax
	.stabn	68,0,66,.LM49-.LFBB3
.LM49:
	leaq	.LC3(%rip), %rdi
	.stabn	68,0,65,.LM50-.LFBB3
.LM50:
	movq	%rax, 16(%rsp)
	.stabn	68,0,66,.LM51-.LFBB3
.LM51:
	xorl	%eax, %eax
	.stabn	68,0,65,.LM52-.LFBB3
.LM52:
	movl	$48, 4(%rsp)
	.stabn	68,0,66,.LM53-.LFBB3
.LM53:
	call	cprintf@PLT
	.stabn	68,0,67,.LM54-.LFBB3
.LM54:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,68,.LM55-.LFBB3
.LM55:
	leaq	.LC4(%rip), %rdi
	xorl	%eax, %eax
	call	cprintf@PLT
...
.LFB3:
	...
	movaps	%xmm7, 192(%rsp)
.L25:
	.stabn	68,0,79,.LM57-.LFBB4
.LM57:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,82,.LM58-.LFBB4
.LM58:
	leaq	224(%rsp), %rax
	.stabn	68,0,83,.LM59-.LFBB4
.LM59:
	movq	%r10, %rsi
	movl	%r11d, %edx
...
.LM60:
	movq	%rax, 8(%rsp)
	leaq	32(%rsp), %rax
	.stabn	68,0,83,.LM61-.LFBB4
.LM61:
	leaq	.LC5(%rip), %rdi
	.stabn	68,0,82,.LM62-.LFBB4
.LM62:
	movq	%rax, 16(%rsp)
	.stabn	68,0,83,.LM63-.LFBB4
.LM63:
	xorl	%eax, %eax
	.stabn	68,0,82,.LM64-.LFBB4
.LM64:
	movl	$24, (%rsp)
	movl	$48, 4(%rsp)
	.stabn	68,0,83,.LM65-.LFBB4
.LM65:
	call	cprintf@PLT
	.stabn	68,0,84,.LM66-.LFBB4
.LM66:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,85,.LM67-.LFBB4
.LM67:
	xorl	%eax, %eax
	leaq	.LC4(%rip), %rdi
	call	cprintf@PLT
	.stabn	68,0,87,.LM68-.LFBB4
.LM68:
	movq	24(%rsp), %rax
	subq	%fs:40, %rax
	jne	.L28
