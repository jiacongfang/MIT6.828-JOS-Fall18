...
void page_init(void)
{
	...
	// cprintf("page number: IOPHYSMEM = %d, EXTPHYSMEM = %d, kern_pgdir = %d, boot_alloc(0) = %d\n ",
	// 		PGNUM(IOPHYSMEM),
	// 		PGNUM(EXTPHYSMEM),b
	// 		PGNUM(PADDR(kern_pgdir)),
	// 		PGNUM(PADDR(boot_alloc(0))));
	size_t i;
	// The page 0 are in use.
	pages[0].pp_ref = 1;
...
page_alloc(int alloc_flags)
{
	...
	returned_page->pp_ref = 0;

	if (alloc_flags & ALLOC_ZERO)
	{
		// Fill the entire page with '\0' bytes
