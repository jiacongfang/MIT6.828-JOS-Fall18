...
int sys_env_set_zerodiv_upcall(envid_t envid, void *upcall)
{
	return syscall(SYS_env_set_zerodiv_upcall, 1, envid, (uint32_t)upcall, 0, 0, 0);
}

int sys_env_set_gpflt_upcall(envid_t envid, void *upcall)
{
	return syscall(SYS_env_set_gpflt_upcall, 1, envid, (uint32_t)upcall, 0, 0, 0);
}

int sys_env_set_illop_upcall(envid_t envid, void *upcall)
{
